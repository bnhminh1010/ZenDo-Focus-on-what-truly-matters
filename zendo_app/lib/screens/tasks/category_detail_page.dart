...
class CategoryDetailPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Consumer<TaskModel>(
        builder: (context, taskModel, child) {
          ...
          final categoryTasks = taskModel.tasks
              .where((task) => task.category.displayName.toLowerCase() == categoryName.toLowerCase())
              .toList();
  ...
  Widget _buildTaskItem(BuildContext context, dynamic task, TaskModel taskModel) {
    return Container(
